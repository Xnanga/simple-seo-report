...
*/
  ...
  var Ja = function (a) {
    ...
    La = function (a) {
      ...
      w(Ka.test(a), "%s does not match the safe URL pattern", a) ||
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  var A = window,
    ...
    D = function () {
      var a;
      if ((a = Object.create) && Xa.test(a)) a = a(null);
      else {
        a = {};
  ...
  var J = function (a, b, c) {
    ...
    sb = function (a, b) {
      ...
      b instanceof Na && b.constructor === Na
        ? (b = b.O)
        : (ya(
    ...
    Ac = function () {
      if (!yc) {
        ...
        if (window.self !== window.top) {
          ...
          for (var e in xc) 0 < xc[e] && (b = J(a, e, "")) && (zc[e] = b);
        }
        yc = !0;
      }
      e = D();
  ...
  var Ic =
    ...
    Kc = function (a) {
      ...
      null == b &&
        ...
        (b = J(a, "authuser") || null),
        null == b && (b = (b = a.match(Ic)) ? b[1] : null));
    ...
    Lc = function (a) {
      ...
      null == b &&
        (b = (a = (a || window.location.href).match(Jc)) ? a[1] : null);
      if (null == b) return null;
      b = String(b);
      21 < b.length && (b = null);
      return b;
  ...
  var Mc,
    ...
    md = function (a) {
      if (-1 !== T) return kd(), U ? p.JSON.stringify.call(p.JSON, a) : X(a);
    },
    nd =
  ...
  qd.prototype.update = function (a, b) {
    if (null != a) {
      void 0 === b && (b = a.length);
      for (var c = b - this.blockSize, d = 0, e = this.L, f = this.v; d < b; ) {
        if (0 == f) for (; d <= c; ) rd(this, a, d), (d += this.blockSize);
        if ("string" === typeof a)
          for (; d < b; ) {
  ...
  ud ||
    ((yd = 1e6 * (screen.width * screen.width + screen.height)),
    (zd = Bd(
      B.cookie +
        "|" +
        B.location +
    ...
    (vd = S("random/maxObserveMousemove") || 0),
    0 != vd && vb("mousemove", Ad, "add", "at"));
  var Cd = function () {
      var a = L.onl;
      if (!a) {
        a = D();
    ...
    Dd = function (a, b) {
      b = b.onload;
      return "function" === typeof b ? (Cd().a(a, b), b) : null;
    },
    Ed = function (a) {
    ...
    Kd = function (a, b, c, d, e) {
      ...
      try {
        document.all &&
          (f = a.createElement(
            '<iframe frameborder="' +
              fb(String(c.frameborder)) +
              '" scrolling="' +
              fb(String(c.scrolling)) +
              '" ' +
              h +
              ' name="' +
              fb(String(c.name)) +
        ...
        f ||
          ((f = (a ? new Ua(Ta(a)) : va || (va = new Ua())).ga("IFRAME")),
          g &&
            ((f.onload = function () {
              f.onload = null;
              g.call(this);
      ...
      for (var k in c)
        (a = c[k]),
          "style" === k && "object" === typeof a
            ? F(a, f.style)
            : Hd[k] || f.setAttribute(k, String(a));
  ...
  var je = function (a, b) {
    ...
    ke = function (a, b, c, d) {
      ...
      if (c.querySelectorAll && (!e || 8 < e)) {
        e = d ? [d] : gb(de).concat(gb(ee)).concat(gb(Y));
      ...
      if (me(ge || {}))
        ...
        d = [];
        for (I in c)
          for (a = c[I], q = 0, b = a.length; q < b; q++)
            (e = a[q]), oe(I, e, $d(e), d, b);
        pe(u, d);
      }
    },
    qe = function (a) {
      ...
      switch (ue(b, a, f)) {
        ...
        case 1:
          if (b.parentNode) {
            ...
            e = h;
            var l = 0;
            do k = e.id || ["I", Id++, "_", new Date().getTime()].join("");
  ...
  Ob.push([
    ...
    function (a, b, c) {
      ...
      if ("explicit" != Q("parsetags")) {
        Db(a);
        Bc(Ac()) && !Q("disableRealtimeCallback") && Fc();
        if (c && (a = c.callback)) {
          var d = hb(a);
          delete c.callback;
        }
  ...
  De.prototype.write = function (a, b) {
    if (!Ee.test(this.N)) throw "Invalid cookie name";
    if (!Fe.test(a)) throw "Invalid cookie value";
    a = this.N + "=" + a;
  ...
  function Le(a) {
    ...
    if (-1 == d) return b;
    var e = Je(a.substr(d + 1));
    if (null == e) return b;
    a = a.substring(0, d);
    if ("_" !== a.charAt(0)) return b;
    d = "E" === c && e.l;
    return (!d && ("U" !== c || e.l)) || (d && !He)
      ? b
      : { X: !0, l: d, la: a.substr(1), domain: e.domain, o: e.o };
  }
  var Me = function (a) {
      if (!a) return [];
      a = a.split("=");
    ...
    Oe = function () {
      ...
      if (null !== a) {
        ...
        Ie.iterate(function (f, g) {
          (f = Le(f)) && f.X && f.l == b.l && f.o == b.o && (c = g);
        });
        if (c) {
          var d = Ne(c),
            e = d && d.ka[Number(a)];
